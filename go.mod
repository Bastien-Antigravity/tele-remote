...
require (
	...
	github.com/Bastien-Antigravity/universal-logger v1.0.5
...
require (
	github.com/Bastien-Antigravity/distributed-config v1.5.1 // indirect
	github.com/Bastien-Antigravity/flexible-logger v1.0.5 // indirect
)
