...
const (
	...
	BotCommand_REFRESH_MENU        BotCommand_CommandType = 3
...
func (x *BotCommand) GetInput() string {
	if x != nil {
		return x.Input
	}
	return ""
...
const file_teleremote_proto_rawDesc = "" +
	...
	"\x0ecustom_payload\x18\x02 \x01(\tR\rcustomPayload\x12\x14\n" +
	"\x05input\x18\x03 \x01(\tR\x05input\"h\n" +
	"\vCommandType\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\r\n" +
	"\tPOWER_OFF\x10\x01\x12\x17\n" +
	"\x13CLOSE_ALL_POSITIONS\x10\x02\x12\x10\n" +
	"\fREFRESH_MENU\x10\x03\x12\x12\n" +
